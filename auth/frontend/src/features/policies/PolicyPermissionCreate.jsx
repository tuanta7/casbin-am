...
const PolicyPermissionCreate = ({ setShowForm }) => {
  const { id } = useParams();
  ...
  const { isPending: isCreating, mutate } = useMutation({
    mutationFn: (data) =>
      fetchWithCredentials(`/policies/${id}/permissions`, "POST", data),
    onSuccess: () => {
...
PolicyPermissionCreate.propTypes = {
  setShowForm: PropTypes.func.isRequired,
};

export default PolicyPermissionCreate;
